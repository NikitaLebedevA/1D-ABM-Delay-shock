...
# class InformationDelayShock(Event):
#     def __init__(self, idx: int, it: int, lag: int, trader_start, trader_end):
#         super().__init__(idx, it)
#         self.lag = lag
#         self.trader_start = trader_start
#         self.trader_end = trader_end
#         self.action = it

#     def __repr__(self):
#         return f'information delay shock (exchange={self.idx}, it={self.it}, lag={self.lag})'

#     def call(self, it: int):
#         print (self.action)
#         if super().call(self.action):
#             return
#         for i in range(self.lag):
#             for trader in self.simulator.traders[self.trader_start:self.trader_end]:
#                 trader.lag = i
#             print(self.action)
#             self.action+=1
